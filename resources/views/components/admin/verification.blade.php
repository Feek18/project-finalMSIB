    ...
    <div class="content" style="padding-top:80px;">
        {{-- kolom summary --}}
        <div class="white bg-white rounded border border-secondary-subtle m-4 gap-3 min-vh-100">
            ...
            <div class="container py-3 px-4">
                <div class="d-flex justify-content-end align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        <button class="btn fw-semibold px-2 py-1" style="border-color: #002379; color: #002379; font-size:15px">
            ...
            <div class="container py-3 d-flex justify-content-end px-4">
