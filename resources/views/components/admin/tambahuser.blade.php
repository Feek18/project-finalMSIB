            ...
            <div class="container mt-5">
                <form method="POST" action="{{ route('admin.storeuser') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="email" class="form-label fw-semibold"
                                    style="color: #002379">Email</label>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="no_hp" class="form-label fw-semibold" style="color: #002379">No
                                    HP</label>
                                <input type="tel" class="form-control" id="no_telephone" name="no_telephone"
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="password" class="form-label fw-semibold"
                                    style="color: #002379">Password</label>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="confirm_password" class="form-label fw-semibold"
                                    style="color: #002379">Confirm Password</label>
                                <input type="password" class="form-control" id="password_confirmation"
                                    name="password_confirmation">
                            </div>
                        </div>
                        <div class="col-md-12 text-center my-2">
                            <button type="submit" class="btn fw-semibold text-white px-3 py-1"
