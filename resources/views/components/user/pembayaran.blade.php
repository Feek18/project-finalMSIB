...
<body>
    ...
    <section>
        <div class="container mt-5" style="padding-top: 70px">
            ...
            <div id="book" class="py-5">
                <div class="books d-flex justify-content-center gap-2 equal-height">
                    <div class="card p-3 card-custom" style="max-width: 950px;">
                        <div>
                            ...
                            <div>
                                ...
                                <span class="py-3 d-block" style="color: #002379">Proses verifikasi oleh admin kurang
                                    dari 30 menit setelah pembayaran berhasil</span>
                            </div>
                        </div>
                        <div class="card p-3 mt-4">
                            <form action="{{ route('verifikasi') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn mt-3"
                                    style="background-color: #002379; color: #FFFF;">Upload Bukti Pembayaran</button>
                            </form>
                        </div>
                    </div>
                    <div class="card p-3 card-custom mx-auto" style="max-width: 450px;">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h2>Booking</h2>
